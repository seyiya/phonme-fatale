...
<script type="text/javascript">
	...
	function sendIt(){
		...
		f.action = "<%=cp%>/fatale/pwSearch_ok.do";
		f.submit();
	...
	<div class="wrapper">
		<div class="wrapper_inner">
			...
			<div class="gallery_item">
				<br><br>
				<font color="#7a7ebf"><h1>비밀번호 찾기</h1></font>
				
				<form action="" method="post" name="myForm">
					<hr width="350px">
					<br><font size="4pt" color="#2E338C">아&nbsp;이&nbsp;디</font> 
					...
					<br>
					<br> <font size="4pt" color="#2E338C">휴대전화&nbsp;</font> 
					<input type="text" name="tel"
						style="width: 250px; height: 35px; padding-left: 15px; text-align: left; background-color: #DFDFEB; font-family: 'Do Hyeon', sans-serif; font-size: 14pt; color: #666; vertical-align: middle; border-color: white; border: 0">
					<br><br><hr width="350px">
					<hr color="white" style="height: 1px; margin: 9px 0px;">

					<!-- 버튼 -->
					<input type="button" value="뒤로 가기"  class="bokyung_button1"
							onclick ="javascript:location.href='<%=cp%>/fatale/login.do';">
					<input type="button" value="비밀번호 찾기" class="bokyung_button1"
						onclick="sendIt();"> 
					<hr color="white" style="height: 1px; margin: 8px 0px;">
